...
def prime_func(request):  # Return Dict object
    ...
    for i in range(length_of_current_trends):
        ...
        trend_obj, created = prime_models.Trend.objects.get_or_create(name=current_trends_list[i]['name'],
                                                                      url=current_trends_list[i]['url'],
                                                                      query=current_trends_list[i]['query'])
        ...
        try:
            ...
            prime_models.Log.objects.create(
                message='Unique Constraint Failed for Unique Tweet Id for trend {}'.format(trend_obj.name))
